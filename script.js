//Function that displays the fetched tasks in the DOM.
...
//Function that creates a list-item for a task and sets the correct values in the DOM.
...
//Function that adds event listeners to every button/checkbox in the task-list as soon as the DOM has loaded in.
...
//Function that changes style + database on checkbox change.
...
//Function that changes the description in the database when the text is changed.
...
//Function that removes the list-item from the DOM on button-click.
...
//Function that creates a new list-item on clicking the 'add' button.
