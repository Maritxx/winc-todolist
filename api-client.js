//Function that fetches the array of tasks from the database.
...
//Function that updates if the task is done or not in the database.
...
//Function that updates the description in the database when the text is changed.
